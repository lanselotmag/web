...
#sudo mysql -uroot -e "CREATE USER 'boxdb'@'localhost';"
#sudo mysql -uroot -e "SET PASSWORD FOR 'boxdb'@'localhost'=PASSWORD('password1');"
#sudo mysql -uroot -e "GRANT ALL PRIVILEGES ON stepik.* TO 'boxdb'@'localhost';"
